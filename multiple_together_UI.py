...
#loading the model
loaded_model1=pickle.load(open('E:/Shreya/Internships/ProdigyInfotech/Task1_HousePrediction/WebApp on Render using Streamlit/House_model.sav','rb'))
loaded_model2=pickle.load(open('E:/Shreya/Internships/ProdigyInfotech/Task2_KmeansClustering/cust_segm.sav','rb'))
